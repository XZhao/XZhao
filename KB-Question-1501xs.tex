...
{\em Instance}: A set of components $C=\{\alpha_1,\cdots,\alpha_n\} \subseteq R$, %over the variables $X \cup A$, 
a target formula $\beta \in T$, \color{red} and a set $X$ of variables. \color{black}\\
...
{\em Instance}: A Set of components $C=\{\alpha_1,\cdots,\alpha_n\} \subseteq R$, %over the variables $X \cup A$ and 
a target formula $\beta \in T$, \color{red} and two sets $X,Y$ of variables.\color{black}\\ %over the variables $Y \cup B$.\\
